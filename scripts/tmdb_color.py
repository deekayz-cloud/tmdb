...
movies_dir = os.path.join(OUTPUT_ROOT, "images", "movies_color")
tv_dir = os.path.join(OUTPUT_ROOT, "images", "tv_color")
...
with open(os.path.join(OUTPUT_ROOT, "tmdb_movies_color.json"), "w", encoding="utf-8") as f:
    json.dump(movie_items, f, ensure_ascii=False, indent=2)
with open(os.path.join(OUTPUT_ROOT, "tmdb_tv_color.json"), "w", encoding="utf-8") as f:
